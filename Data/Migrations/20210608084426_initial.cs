        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 6, 8, 15, 44, 25, 741, DateTimeKind.Local).AddTicks(3978)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "a025fb32-089e-47af-a5d5-e4487460435d", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "3b761c47-56b3-4d3f-82dc-dc68e06a963e", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "duongrbt@gmail.com", true, "Dinh", "Duong", false, null, "duongrbt@gmail.com", "d", "AQAAAAEAACcQAAAAEH2apD2b11Q5Iw2AMYxOjEJAZnQJ37BD1EX2G+TtnKOD+2RTUWpYHP4QUPj7S8IyJQ==", null, false, "", false, "d" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 6, 8, 15, 44, 25, 764, DateTimeKind.Local).AddTicks(7652), 100000m, 200000m });
